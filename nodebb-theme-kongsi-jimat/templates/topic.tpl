                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column flex-md-row gap-4">
                            ...
                            <div class="flex-shrink-0" style="max-width: 200px;">
                                <img src="{deal_image}" class="img-fluid rounded" alt="{title}" style="max-height: 200px; object-fit: contain;">
                            </div>
                            {{{ end }}}
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-baseline gap-2 mb-2">
                                    <h2 class="text-danger fw-bold mb-0">RM {deal_price}</h2>
                                    {{{ if deal_list_price }}}
                                    <span class="text-decoration-line-through text-muted small">RM {deal_list_price}</span>
                                    {{{ end }}}
                                </div>
                                {{{ if deal_store }}}
                                <div class="mb-2">
                                    <span class="badge bg-secondary"><i class="fa fa-shopping-cart"></i> {deal_store}</span>
                                </div>
                                {{{ end }}}
                                {{{ if deal_url }}}
                                <a href="{deal_url}" target="_blank" class="btn btn-primary fw-bold px-4">See Deal <i class="fa fa-external-link"></i></a>
                                {{{ end }}}
                            </div>
                        </div>
                    </div>
